...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'providers', href: '/admin/aanbieders' },
  { key: 'bookings',  href: '/admin/boekingen' },
  { key: 'users',     href: '/admin/gebruikers' },
];
    ...
    <aside className="w-52 shrink-0">
      <div className="sticky top-24 flex flex-col gap-1">
        ...
        {NAV_ITEMS.map(({ key, href }) => {
          const active =
            key === 'overview' ? pathname === '/admin' : pathname.startsWith(href);
          return (
            <Link
              key={key}
              href={href}
